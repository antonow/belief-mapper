...
#   end
# end
u1 = User.create!(:email => Faker::Internet.email, :password => 'password', :password_confirmation => 'password')
u2 = User.create!(:email => Faker::Internet.email, :password => 'password', :password_confirmation => 'password')

b1 = Belief.create!(name: "asdf", definition: "qwer", user_count: 1)
b2 = Belief.create!(name: "zxcv", definition: "tyui", user_count: 1)

c1 = Connection.create!(belief_1_id: b1.id, belief_2_id: b2.id, count:  1)
